...
public partial class PossibleTimeLossSettings : UserControl
{
    ...
    public bool TotalTimeLoss { get; set; }
    public bool DropDecimals { get; set; }

    public LayoutMode Mode { get; set; }

    public PossibleTimeLossSettings()
    {
        InitializeComponent();
        ...
        chkTotalTimeLoss.DataBindings.Add("Checked", this, "TotalTimeLoss", false, DataSourceUpdateMode.OnPropertyChanged);
    ...
    private void PossibleTimeLossSettings_Load(object sender, EventArgs e)
    {
    ...
    public void SetSettings(XmlNode node)
    {
        ...
        TotalTimeLoss = SettingsHelper.ParseBool(element["TotalTimeLoss"], false);
    }
    ...
    private int CreateSettingsNode(XmlDocument document, XmlElement parent)
    {
        ...
        SettingsHelper.CreateSetting(document, parent, "TotalTimeLoss", TotalTimeLoss);
    }
